...
<div class="kage-card" tabindex="0">
  <div class="kage-image">
    <img class="lazyload" data-src="${restaurant.pictureId ? KAGE_CONFIG.BASE_IMAGE_URL + restaurant.pictureId : 'https://restaurant-api.dicoding.dev/images/medium/<pictureId>'}" alt="${restaurant.title}" loading="lazy">
